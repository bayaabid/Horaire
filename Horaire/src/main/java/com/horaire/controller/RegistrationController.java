...
import com.horaire.registration.OnRegistrationCompleteEvent;
import com.horaire.service.IUserService;
import com.horaire.service.UserDto;
import com.horaire.validation.EmailExistsException;
import com.horaire.web.error.InvalidOldPasswordException;
import com.horaire.web.error.UserAlreadyExistException;
import com.horaire.web.error.UserNotFoundException;
import com.horaire.web.util.GenericResponse;
...
public class RegistrationController {
    ...
    public GenericResponse changeUserPassword(final Locale locale, @RequestParam("password") final String password,
    		@RequestParam("oldpassword") final String oldPassword)throws InvalidOldPasswordException {
